...
export const getSuggestedUsers = async (req, res) => {
    try {
      ...
      const usersFollewedByMe = await User.findById(userId).select('following');
      ...
      const filteredUsers = users.filter((user) => !usersFollewedByMe.following.includes(user._id));
